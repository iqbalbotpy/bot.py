...
cl = LINETCR.LINE()
cl.login(token="EmigYFQcGYhrbFiKihj1.M0arust47ZbaJ2TWH22x4q.G3tJLAWcq8qIDDdrWMy3rs0pcIXZlTfKurU20uGqDdM=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EmLVfhcsnrc9ILuZDhj5.sU7mWgP0zK0fcsMOaYL9jq.99yNpuZetVF2K+bqBnEWaAnRL0xA680fKollFFmNP38=")
ki.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="EmBbbKZoUAZfRPqvvqmc.bnPuaxZ3r8AcFbzvp0S/xa.LJqxzo/CWF0DcmjChe1o4S60n2tkbXOnuj0BlKh3GbA=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="EmapixO8Rl656QYVPpn9.75hhESsy+UchQsxOCwouQq.gtwb5fJBe2vLsElEd0o2lt22lpO3DlJNvVSVwByQ424=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="EmPDaVPZM0n4orKCh71c.UTK0qZA1i7RAwtyjsDB23a.tRNH/jxQ35kBynC4N8k6rTteNMj+3gLOsZe1L2U9+5U=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Em6gpkNte3dbHkXk9Ugb.PIWuw1mBEHIOxkiRv3+kwW.VqqltMOaGuejVvDl30Z4HEjp2hdZPvuVsPhcGsMEt/Y=")
ki5.loginResult()

ki6 = LINETCR.LINE()
ki6.login(token="EmzLKswGeSP6PmMCPwi5.wlV9l/G2o4hAcmsUdab1Tq.cgPFhm3GO2iePeMlUkDIeCXVAF91ga7mqS+nKLlz3Iw=")
ki6.loginResult()
...
║☣ protect on
║☣ qrprotect on
║☣ invite protect on/off
║☣ cancelprotect on/off
╠════════════
║ ᴄʀᴇᴀᴛᴏʀ ʙᴏᴛ : ✍ɴᴇᴋᴏ✈/ɪϙʙᴀʟ  
║
║N̾̿̃ͬ̓̐̓̽̀̈́̔̓ͨ͑̓͗̌ͭ̀̚̕͜͏̖̻̬̱͕̙̞͎̦̝̬̬̝̗͉́ͅE̿̑ͤ͂̏̇͐̍̎̔̊͂̚͏̵͈̖͔̖̼̥̳͇̟̻̠̭̭̥͢͟K̷̶̸̜͇͉̰͓̩̥͇̟͕͉̼̮͉̳̲̥͛͒͗͐̑̈́ͩ̈́͆ͫ̾̂ͭ̕͠ͅͅỜ̡̛͚̣̟̤̝̙̗̣̗̼͇̟̺̮̝̎͑̓͋ͫ̑̾̓̆̐͡͡ͅͅ 
║
║
║☞ http://line.me/ti/p/~nekov02 ☜
╚════════════
"""
helo=""
...
admin =["u7336a42cd799ac25a03d6da0e430f82f"]
...
✍T҉̶̘̟̼̉̈́͐͋͌̊Σ̶Δ̶M҉̶̘͈̺̪͓̺ͩ͂̾ͪ̀̋ ̶̶̶N̾̿̃ͬ̓̐̓̽̀̈́̔̓ͨ͑̓͗̌ͭ̀̚̕͜͏̖̻̬̱͕̙̞͎̦̝̬̬̝̗͉́ͅE̿̑ͤ͂̏̇͐̍̎̔̊͂̚͏̵͈̖͔̖̼̥̳͇̟̻̠̭̭̥͢͟K̷̶̸̜͇͉̰͓̩̥͇̟͕͉̼̮͉̳̲̥͛͒͗͐̑̈́ͩ̈́͆ͫ̾̂ͭ̕͠ͅͅỜ̡̛͚̣̟̤̝̙̗̣̗̼͇̟̺̮̝̎͑̓͋ͫ̑̾̓̆̐͡͡ͅͅ✈""",
...
#-----------------------------------------------
                ...
                ki2.sendText(msg.to,"Hadir...3")
                ki3.sendText(msg.to,"Hadir...4")
                ki4.sendText(msg.to,"Hadir...5")
                ki5.sendText(msg.to,"Hadir...6")
                ki6.sendText(msg.to,"Hadir...7")
#--------------------------------------------------------
		...
		cl.sendMessage(msg)
                ...
                for i in gid:
                    ...
                    ki6.leaveGroup(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"✍ NEKO✈Sudah Keluar Di semua grup")
                else:
...
#-------------------Fungsi Spam Start----------------------#
                ...
                if msg.from_ in admin:
                    cl.sendText(msg.to,"Tu")
                    cl.sendText(msg.to,"Wa")
                    cl.sendText(msg.to,"Ga")
                    cl.sendText(msg.to,"pat")
...
#-----------------------------------------------
                ...
                ki.sendText(msg.to,"""      􀜁􀇔􏿿􀜁􀇔􏿿 NEKO BOT  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb1 Gift]\n􀜁􀇔􏿿[Kb1 bye]\n\n   
  
        
  
☆ B̵̺̦̦̫̦͉̳̜͋̃̅̎͒̇̚͞͠ǫ͈̮̼͍̙̰̜̔̀͛̀̐͌͟͡͝t̶̨͓̰̩̎͐̀͑̋̋͢͠


""")
                ki2.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿   NEKO BOT 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb2 in]\n􀜁􀇔􏿿[2name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb2 Gift]\n􀜁􀇔􏿿[Kb2 bye]\n\n     
...
""")
                ki3.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 NEKO BOT 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb3 in]\n􀜁􀇔􏿿[3name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔��[Kb3 Gift]\n��􀇔􏿿[Kb3 bye]\n\n     
        
  
☆B̵̺̦̦̫̦͉̳̜͋̃̅̎͒̇̚͞͠ǫ͈̮̼͍̙̰̜̔̀͛̀̐͌͟͡͝t̶̴̨̡͓̰̩͈̖̺͖̙̝̩̞̎͐̀͑̋̋͂̏͢͟͠͠☆



""")
                ki4.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 NEKO BOT  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb4 in]\n􀜁􀇔􏿿[4name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb4 Gift]\n􀜁􀇔􏿿[Kb4 bye]\n\n     
...
""")
                ki5.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 NEKO BOT 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb5 in]\n􀜁􀇔􏿿[5name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb5 Gift]\n􀜁􀇔􏿿[Kb5 bye]\n\n     
...
""")
                ki6.sendText(msg.to,"""     􀜁􀇔􏿿􀜁􀇔􏿿 NEKO BOT 􀜁􀇔􏿿􀜁􀇔􏿿  \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb6 in]\n􀜁􀇔􏿿[6name:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Kb6 Gift]\n􀜁􀇔􏿿[Kb6 bye]\n\n     
...
def autolike():
     for zx in range(0,50):
	    ...
	    cl.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            cl.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki2.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki2.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki3.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki3.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki4.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki4.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki5.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki5.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by NeKo✈\n\nhttp://line.me/ti/p/~nekov02")
	    ki6.like(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],likeType=1002)
            ki6.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"Auto Like by Neko✈\n\nhttp://line.me/ti/p/~nekov02")
            print "Like"
          except:
            pass
        else:
